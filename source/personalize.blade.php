    ...
    <main class="page-content page-engaje" id="engaje">
        ...
        <section class="article-center bg-cinza separator" id="gatilhos-comportamentais">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-12 pr-5">
                    <ul class="list-unstyled slider slider-gatilhos-comportamentais">
                        ...
                        <li class="slider--item">
                            <img src="{{ $page->baseUrl }}/assets/images/compreenda/carousel/abandono-de-navegacao.jpg" width="375" />
                            <p>Abandono de Navegação</p>
                        </li>

                        <li class="slider--item">
                            <img src="{{ $page->baseUrl }}/assets/images/compreenda/carousel/recomendacoes.jpg" width="375" />
                            <p>Recomendações</p>
                        </li>

                        <li class="slider--item">
                            <img src="{{ $page->baseUrl }}/assets/images/compreenda/carousel/reconquista.jpg" width="375" />
                            <p>Reconquista</p>
                        </li>
                        <li class="slider--item">
                            <img src="{{ $page->baseUrl }}/assets/images/compreenda/carousel/reducao-de-preco.jpg" width="375" />
